...
export const pageTitles: TitleMapping = {
  ...
  "/:orgCode/admin/tna/employees": "Employee TNA Summary",
  "/:orgCode/admin/tna/execution": "Training Management",
  "/:orgCode/admin/tna/development-plan": "Employee Development Plan",
