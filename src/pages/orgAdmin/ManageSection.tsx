...
import CreateModuleTab from "../instructor/CreateModuleTab";
...
export default function ManageSection() {
  ...
  useEffect(() => {
    const isKnownTab = tabs.some((tab) => tab.value === activeTab);
    if (!isKnownTab) {
      const currentParams = Object.fromEntries(searchParams.entries());
      setSearchParams({ ...currentParams, tab: "modules" });
      return;
    }
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6">
      <div className="md:mb-4">
        <Button
          ...
          onClick={() => {
            navigate(location.pathname.replace("/manage", ""));
          }}
          disabled={isPending}
        >
          <FaAngleLeft /> Go back
